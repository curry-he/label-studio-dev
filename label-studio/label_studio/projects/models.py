...
class VersionTask(models.Model):
    version = models.ForeignKey(DatasetVersion, on_delete=models.CASCADE, related_name='tasks')
    task = models.ForeignKey('tasks.Task', on_delete=models.CASCADE)
    subset = models.CharField(max_length=32, choices=[('train', 'Train'), ('test', 'Test'), ('valid', 'Validation')])
